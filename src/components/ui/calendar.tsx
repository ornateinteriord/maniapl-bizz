  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-gray-500 rounded w-8 font-normal text-[0.8rem]",
        row: "flex w-full mt-2",
        cell: cn(
          "relative p-0 text-center text-sm focus-within:relative [&:has([aria-selected])]:bg-blue-100 [&:has([aria-selected].day-outside)]:bg-blue-50",
          props.mode === "range"
